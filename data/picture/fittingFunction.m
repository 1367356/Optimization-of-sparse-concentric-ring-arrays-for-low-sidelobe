...
legend('line1: Linear function model','line2: Gauss function model','line3: Sine function model','line4: Power function model','line5: Rational function model','line6: polynomial funtion model','Fitting data') %可依次设置成你想要的名字
hold on
ylabel('\itP_n','FontSize',10.5);
xlabel('\itr_n(λ)','FontSize',10.5);
% xlable('r_n(\lamda)')
% ylable('P_n')