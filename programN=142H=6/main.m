...
lamda=1;
circle_num=6;
element_num=142;         %输入为0，就是不限制阵元数目，输入为非0，就是有阵元总数的限制。
L=9.4;
...
%%%%%%%%%%将其中一列替换为较好的数据
Population_Init(2,2)=0.8364;
Population_Init(3,2)= 1.3713;
Population_Init(4,2)= 2.1027;
Population_Init(5,2)= 2.9468;
Population_Init(6,2)=3.7772;
Population_Init(7,2)=4.7000;
